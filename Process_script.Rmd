...
Another useful attribute for grouping or subsetting is knowing the number of observations per pass. This can be added with `dplyr::add_tally` which perform
...
* Makes actual pass numbers variable, `pass_num`, a factor for plotting.
